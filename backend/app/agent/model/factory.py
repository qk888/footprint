...
# 模型服务地址从环境变量读取：容器内指向 chat-model/embed-model 服务，原生运行用本机默认端口
load_dotenv()
CHAT_MODEL_BASE_URL = os.getenv("CHAT_MODEL_BASE_URL", "http://127.0.0.1:8080/v1")
EMBED_MODEL_BASE_URL = os.getenv("EMBED_MODEL_BASE_URL", "http://127.0.0.1:8081/v1")
